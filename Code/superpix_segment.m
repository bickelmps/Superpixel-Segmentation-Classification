...
% MIT License
% Copyright (c) 2019 Valentin Tertius Bickel

% Please refer to this routine as:
% Bickel, V.T.
% "Multi-channel Superpixel Segmentation & user-guided k-means Clustering. 2019.

clear
clc

%% Read channels & Inputs
img = im2double(imread('layering.jpg'));
disp('Segmenting with:')
sup_pix = 3000 % number of used super-pixels, ADAPT MANUALLY!
